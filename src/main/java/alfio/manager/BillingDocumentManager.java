...
public class BillingDocumentManager {
    ...
    private Map<String, Object> prepareModelForBillingDocument(Event event, TicketReservation reservation, OrderSummary summary, BillingDocument.Type type) {
        ...
        Map<String, Object> model = TemplateResource.prepareModelForConfirmationEmail(organization, event, reservation, vat, ticketsWithCategory, summary, "", "", configurationManager.getShortReservationID(event, reservation), invoiceAddress, bankAccountNr, bankAccountOwner, Map.of());
