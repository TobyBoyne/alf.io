...
public class OnlineCheckInFullInfo {
    ...
    public OnlineCheckInFullInfo(@Column("t_id") int id,
                                 ...
                                 @Column("e_display_name") String eventDisplayName,
                                 @Column("e_start_ts") ZonedDateTime eventStartTs,
                                 @Column("e_end_ts") ZonedDateTime eventEndTs,
