...
public interface ErrorsCode {
    ...
    String STEP_1_CATEGORIES_NOT_COMPATIBLE = "error.STEP_1_CATEGORIES_NOT_COMPATIBLE";
    ...
    String STEP_2_INVALID_VAT = "error.STEP_2_INVALID_VAT";
    String STEP_2_WHITELIST_CHECK_FAILED = "error.STEP_2_WHITELIST_CHECK_FAILED";
