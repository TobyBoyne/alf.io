...
alter table ticket_category add column ticket_validity_start timestamp with time zone;
alter table ticket_category add column ticket_validity_end timestamp with time zone;
