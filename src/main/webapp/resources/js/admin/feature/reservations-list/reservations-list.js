    ...
    function ReservationsListCtrl(EventService, $filter, $location, $stateParams) {
        ...
        function loadData(loadPartially) {
            ...
            if(loadPartially.paymentPending) {
                EventService.findAllReservations(ctrl.event.shortName, ctrl.currentPagePendingPayment - 1, ctrl.toSearch, ['IN_PAYMENT', 'EXTERNAL_PROCESSING_PAYMENT', 'WAITING_EXTERNAL_CONFIRMATION', 'OFFLINE_PAYMENT', 'DEFERRED_OFFLINE_PAYMENT']).then(function (res) {
